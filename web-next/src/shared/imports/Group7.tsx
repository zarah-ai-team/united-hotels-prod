import svgPaths from "@/shared/imports/svg-443s8vvh0y";
const imgRectangle10 = "/figma-assets/2e73560823491cb7aae2b44b94830399bada8384.png";

function Group() {
  return (
    <div className="absolute contents left-[432px] not-italic text-[#fafafa] text-center top-[259px]">
      <p className="-translate-x-1/2 absolute font-['Poppins:Bold',sans-serif] leading-[72px] left-[960.5px] text-[64px] top-[259px] w-[1057px]">{` Hotels in Turkey Direct Rates No Hidden Fees`}</p>
      <p className="-translate-x-1/2 absolute font-['Inter:Regular',sans-serif] font-normal leading-[28.8px] left-[960.5px] text-[20px] top-[411px] w-[737px]">Handpicked affordable hotels in the best neighborhoods of Turkey. Verified. Transparent. Local support.</p>
    </div>
  );
}
...
function Container3() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] h-[78px] items-start left-[720.5px] top-0 w-[331px]" data-name="Container">
      <Label2 />
      <Container4 />
    </div>
  );
    ...
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
          ...
          <path d={svgPaths.p22db3fc0} id="Vector_2" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
export default function Group1() {
  return (
    <div className="relative size-full">
      ...
      <Group />
      <Frame5 />
      <div className="absolute bottom-0 h-[907px] left-0 pointer-events-none top-0">
        <Navigation />
      </div>
    </div>
  );
