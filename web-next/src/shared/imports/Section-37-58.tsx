import svgPaths from "@/shared/imports/svg-uoyp77ode6";
const imgImageHotelInspection = "/figma-assets/9783e6851bc031fabe001ad50fc466eb1ba42e2e.png";

function ImageHotelInspection() {
  return (
    <div className="h-[754px] relative shrink-0 w-full" data-name="Image (Hotel inspection)">
...
function Container() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0)] content-stretch flex flex-col h-[754px] items-start left-[117px] overflow-clip rounded-[20px] shadow-[0px_16px_48px_0px_rgba(0,0,0,0.08)] top-[59px] w-[912px]" data-name="Container">
  ...
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
          <path d={svgPaths.p1ef99f00} id="Vector" stroke="var(--stroke-0, #1ABC9C)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function Group() {
  return (
    <div className="absolute contents left-[117px] top-[59px]">
      <Container />
      <Container1 />
    </div>
  );
