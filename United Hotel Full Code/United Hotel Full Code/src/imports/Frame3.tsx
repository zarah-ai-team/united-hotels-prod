import svgPaths from "./svg-nnzqmx1xjq";
...
function Paragraph() {
  return (
    <div className="absolute h-[60px] left-[292px] top-[79.99px] w-[640px]" data-name="Paragraph">
      <p className="-translate-x-1/2 absolute font-['Inter:Regular',sans-serif] font-normal leading-[30px] left-[320.14px] not-italic text-[#6b7280] text-[20px] text-center top-[-0.27px] w-[611px]">{`We specialize exclusively in budget stays in Turkey. Here's how we're different.`}</p>
    </div>
  );
}
...
function Group() {
  return (
    <div className="absolute contents left-[calc(16.67%+112px)] not-italic text-[#fafafa] text-center top-[259px]">
      <p className="-translate-x-1/2 absolute font-['Poppins:Bold',sans-serif] leading-[72px] left-[calc(16.67%+640.5px)] text-[64px] top-[259px] w-[1057px]">Budget Hotels in Turkey Direct Rates. No Hidden Fees</p>
      <p className="-translate-x-1/2 absolute font-['Inter:Regular',sans-serif] font-normal leading-[28.8px] left-[calc(25%+480.5px)] text-[20px] top-[411px] w-[737px]">Handpicked affordable hotels in the best neighborhoods of Turkey. Verified. Transparent. Local support.</p>
    </div>
  );
}
  ...
  return (
    <div className="absolute bg-[#fafafa] h-[49px] left-0 rounded-[8px] top-0 w-[312px]" data-name="Text Input">
      <div className="content-stretch flex items-center overflow-clip pl-[40px] pr-[16px] py-[12px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#0a0a0a] text-[16px] whitespace-nowrap">Turkey</p>
      </div>
...
function Frame6() {
  return (
    <div className="content-stretch flex gap-[7px] items-center relative shrink-0 w-[175px]">
      <Icon9 />
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] not-italic relative shrink-0 text-[16px] text-center text-white whitespace-nowrap">Find Budget Hotels</p>
    </div>
  );
}
...
function Button() {
  return (
    <div className="bg-[#1abc9c] content-stretch flex flex-col items-start px-[32px] py-[13px] relative rounded-[8px] shrink-0 w-[239px]" data-name="Button">
      <Frame6 />
    </div>
  );
}
...
function Paragraph5() {
  return (
    <div className="absolute h-[60px] left-[292px] top-[87.98px] w-[640px]" data-name="Paragraph">
      <p className="-translate-x-1/2 absolute font-['Inter:Regular',sans-serif] font-normal leading-[30px] left-[320.05px] not-italic text-[#6b7280] text-[20px] text-center top-[-0.27px] w-[584px]">{`Handpicked stays offering exceptional value in Turkey's best neighborhoods`}</p>
    </div>
  );
}
...
function Heading13() {
  return (
    <div className="h-[120px] relative shrink-0 w-full" data-name="Heading 2">
      <p className="absolute font-['Poppins:Bold',sans-serif] leading-[60px] left-0 not-italic text-[#3b3b3b] text-[40px] top-[1.82px] w-[727px]">Budget Hotels in Turkey – Affordable Stays in Prime Locations</p>
    </div>
  );
}
  ...
  return (
    <div className="absolute h-[91.79px] left-0 top-0 w-[744.006px]" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[0] left-0 not-italic text-[#4b5563] text-[17px] top-[0.54px] w-[727px]">
        ...
        <span className="[text-decoration-skip-ink:none] decoration-solid leading-[30.6px] text-[#1abc9c] underline">budget accommodation in Turkey</span>
        <span className="leading-[30.6px]">{` doesn't mean compromising on comfort or location. At United Hotels, we've personally inspected and selected the best affordable hotels across Turkey's most popular neighborhoods.`}</span>
      </p>
    </div>
  );
}
  ...
  return (
    <div className="absolute h-[30.597px] left-[21.56px] top-0 w-[595.142px]" data-name="Text">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[0] left-0 not-italic text-[#4b5563] text-[0px] text-[17px] top-[0.54px] whitespace-nowrap">
        ...
        <span className="font-['Inter:Regular',sans-serif] font-normal leading-[30.6px]">{` Our Turkey-based team personally visits every property`}</span>
      </p>
    </div>
  );
}
  ...
  return (
    <div className="absolute h-[91.79px] left-0 top-[480.1px] w-[744.006px]" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[0] left-0 not-italic text-[#4b5563] text-[17px] top-[0.54px] w-[726px]">
        <span className="leading-[30.6px]">{`Whether you're planning a weekend getaway or extended cultural exploration, our curated selection puts you in Turkey's best neighborhoods without breaking the bank. With `}</span>
...
function Paragraph12() {
  return (
    <div className="h-[26.989px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="-translate-x-1/2 absolute font-['Inter:Regular',sans-serif] font-normal leading-[27px] left-[372.07px] not-italic text-[#6b7280] text-[18px] text-center top-[-0.18px] whitespace-nowrap">Everything you need to know about budget hotels in Turkey</p>
    </div>
  );
}
...
function Text32() {
  return (
    <div className="h-[23.991px] relative shrink-0 w-[464.915px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Poppins:SemiBold',sans-serif] leading-[24px] left-0 not-italic text-[#3b3b3b] text-[16px] top-[0.91px] whitespace-nowrap">What is the average price of a budget hotel in Turkey?</p>
      </div>
    </div>
  );
}
...
function Text33() {
  return (
    <div className="h-[23.991px] relative shrink-0 w-[297.33px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Poppins:SemiBold',sans-serif] leading-[24px] left-0 not-italic text-[#3b3b3b] text-[16px] top-[0.91px] whitespace-nowrap">Are budget hotels in Turkey safe?</p>
      </div>
    </div>
  );
}
...
function Text34() {
  return (
    <div className="h-[23.991px] relative shrink-0 w-[368.864px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Poppins:SemiBold',sans-serif] leading-[24px] left-0 not-italic text-[#3b3b3b] text-[16px] top-[0.91px] whitespace-nowrap">When is the cheapest time to visit Turkey?</p>
      </div>
    </div>
  );
}
...
function Heading20() {
  return (
    <div className="absolute h-[123.182px] left-[48px] top-0 w-[824.006px]" data-name="Heading 2">
      <p className="-translate-x-1/2 absolute font-['Poppins:Bold',sans-serif] leading-[61.6px] left-[calc(50%-0.41px)] not-italic text-[56px] text-center text-white top-[2.91px] w-[805px]">Ready to Book Your Turkey Stay?</p>
    </div>
  );
}
