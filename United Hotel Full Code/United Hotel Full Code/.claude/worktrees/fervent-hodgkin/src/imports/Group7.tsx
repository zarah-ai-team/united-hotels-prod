import svgPaths from "./svg-443s8vvh0y";
...
function Group() {
  return (
    <div className="absolute contents left-[432px] not-italic text-[#fafafa] text-center top-[259px]">
      <p className="-translate-x-1/2 absolute font-['Poppins:Bold',sans-serif] leading-[72px] left-[960.5px] text-[64px] top-[259px] w-[1057px]">{` Hotels in Istanbul Direct Rates No Hidden Fees`}</p>
      <p className="-translate-x-1/2 absolute font-['Inter:Regular',sans-serif] font-normal leading-[28.8px] left-[960.5px] text-[20px] top-[411px] w-[737px]">Handpicked affordable hotels in the best neighborhoods of Istanbul. Verified. Transparent. Local support.</p>
    </div>
  );
}
