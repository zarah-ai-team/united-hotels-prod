...
function FeatureCard({ Icon, title, description, index }: FeatureCardProps) {
  ...
  return (
    <div className="group relative glass-card is-interactive rounded-2xl p-6 md:p-7 overflow-hidden">
      ...
      <div
        aria-hidden
        className="absolute -top-12 -right-12 w-40 h-40 rounded-full bg-gradient-to-br from-[#2F80ED]/15 to-[#38bdf8]/10 blur-2xl opacity-70 group-hover:opacity-100 transition-opacity duration-500"
      />

      {/* Index micro-label */}
      <div className="relative font-['Inter:Medium',sans-serif] text-[9.5px] tracking-[0.28em] uppercase text-[#2F80ED] mb-4">
        0{index + 1}
      </div>

      {/* Icon — gradient ring on hover */}
      <div className="relative w-12 h-12 rounded-2xl bg-gradient-to-br from-white/85 to-white/50 dark:from-white/[0.08] dark:to-white/[0.02] ring-1 ring-[#2F80ED]/20 text-[#2F80ED] flex items-center justify-center shadow-[0_8px_24px_-12px_rgba(47, 128, 237,0.4)] transition-all duration-300 group-hover:ring-[#2F80ED]/45 group-hover:shadow-[0_12px_28px_-10px_rgba(47, 128, 237,0.5)] group-hover:scale-105 mb-5">
      ...
      <div
        aria-hidden
        className="absolute inset-x-6 bottom-0 h-px bg-gradient-to-r from-transparent via-[#2F80ED]/45 to-transparent scale-x-0 group-hover:scale-x-100 origin-center transition-transform duration-500"
      />
    </div>
  );
}
    ...
    <section className="relative overflow-hidden py-10 md:py-32">
      ...
      <div className="absolute inset-0 -z-10">
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 70% 55% at 8% 12%, rgba(47, 128, 237, 0.16), transparent 60%)," +
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 70% 55% at 8% 12%, rgba(93, 160, 248, 0.16), transparent 60%)," +
        ...
        <div className="absolute -top-24 left-1/4 w-72 h-72 rounded-full bg-[#2F80ED]/10 blur-3xl" />
      ...
      <div className="max-w-[1280px] mx-auto px-4 md:px-10 relative">
        ...
        <div className="grid md:grid-cols-[1.1fr_1fr] gap-6 md:gap-16 items-end mb-12 md:mb-16">
          <div>
            <div className="inline-flex items-center gap-2 font-['Inter:Medium',sans-serif] text-[11px] tracking-[0.28em] uppercase text-[#2F80ED] mb-4">
            ...
            <h2 className="font-['Poppins:Bold',sans-serif] text-[32px] md:text-[52px] leading-[1.06] tracking-[-0.024em] text-[#1f2937] dark:text-white">
              {t("Affordable stays.")}{" "}
              <span className="bg-gradient-to-r from-[#2F80ED] via-[#5DA0F8] to-[#38bdf8] bg-clip-text text-transparent">
                {t("Prime locations.")}
              </span>
            </h2>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.05fr_0.95fr] gap-4 md:gap-5">
          ...
          <div className="relative glass-card rounded-3xl p-7 md:p-10 overflow-hidden">
            ...
            <div
              aria-hidden
              className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-[#2F80ED]/30 via-[#5DA0F8]/15 to-transparent blur-2xl"
            />
            {/* Side accent bar */}
            <div className="absolute inset-y-7 md:inset-y-10 left-0 w-[3px] rounded-r-full bg-gradient-to-b from-[#2F80ED] via-[#5DA0F8] to-transparent" />

            <div className="relative pl-3 md:pl-5">
              <div className="flex items-center gap-3 mb-5">
                <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-[#2F80ED] to-[#5DA0F8] text-white flex items-center justify-center shadow-[0_10px_30px_-10px_rgba(47, 128, 237,0.6)]">
              ...
              <h3 className="font-['Poppins:Bold',sans-serif] text-[24px] md:text-[30px] leading-[1.18] tracking-[-0.018em] text-[#1f2937] dark:text-white mb-4">
                ...
                <span className="bg-gradient-to-r from-[#2F80ED] to-[#38bdf8] bg-clip-text text-transparent italic">
                  {t("traveller.")}
                </span>
              </h3>
          ...
          <div className="relative glass-card rounded-3xl p-7 md:p-10 overflow-hidden">
            <div
              aria-hidden
              className="absolute -bottom-20 -right-12 w-56 h-56 rounded-full bg-gradient-to-tr from-[#38bdf8]/15 to-[#2F80ED]/15 blur-3xl"
            />

            <div className="relative">
              <div className="flex items-center gap-3 mb-6 md:mb-7">
                <div className="w-12 h-12 rounded-2xl bg-white/80 dark:bg-white/[0.06] backdrop-blur-md ring-1 ring-[#2F80ED]/25 text-[#2F80ED] flex items-center justify-center shadow-[0_8px_24px_-12px_rgba(47, 128, 237,0.4)]">
              ...
              <ul className="space-y-2">
                {benefits.map((text) => (
                  ...
                  >
                    <div className="shrink-0 w-7 h-7 rounded-full bg-gradient-to-br from-[#2F80ED] to-[#5DA0F8] text-white flex items-center justify-center shadow-[0_4px_14px_-4px_rgba(47, 128, 237,0.55)] transition-transform duration-300 group-hover:scale-110">
              ...
              <div className="mt-6 md:mt-7 pt-5 md:pt-6 border-t border-white/40 dark:border-white/10">
                <div className="flex items-center gap-2 text-[#8c8c8c] dark:text-white/60">
                  <Clock className="w-4 h-4 shrink-0 text-[#2F80ED]" strokeWidth={2} />
