...
const SUPPORT_EMAIL_DOMAIN = "unitedhotels.com";
...
const SOCIAL_ENV: Record<SocialKey, string | undefined> = {
  ...
  x: import.meta.env.VITE_X_URL as string | undefined,
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-7 md:gap-12 mb-8 md:mb-16 text-center md:text-left">
          ...
          <div>
            ...
            <ul className="space-y-2 md:space-y-3">
              ...
              <li>
                <Link to="/groups" className="font-['Inter:Regular',sans-serif] text-[14px] md:text-[15px] text-white/70 hover:text-white transition-colors">
                  {t("Groups")}
                </Link>
              </li>
              <li>
                <Link to="/blog" className="font-['Inter:Regular',sans-serif] text-[14px] md:text-[15px] text-white/70 hover:text-white transition-colors">
                  {t("Travel Guides")}
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <address className="not-italic">
              <ul className="space-y-2.5 md:space-y-4">
                ...
                <li>
                  {/* Obfuscated mail link — href is rebuilt on click so the
                      raw string is never present in the rendered HTML. */}
                  <a
                    href="#contact"
