...
import { useSEO, faqLd, breadcrumbLd } from "../hooks/useSEO";
      ...
      <section className="py-12 md:py-20 bg-[#fafafa]">
        <div className="max-w-[1840px] mx-auto px-5 md:px-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16 items-center">
            {/* Map Placeholder */}
            <div className="bg-gray-200 rounded-2xl h-[220px] md:h-[400px] flex items-center justify-center order-2 lg:order-1">
              <MapPin className="w-12 h-12 md:w-16 md:h-16 text-gray-400" />
            </div>
