...
function Paragraph() {
  return (
    <div className="absolute h-[60px] left-[292px] top-[79.99px] w-[640px]" data-name="Paragraph">
      <p className="-translate-x-1/2 absolute font-['Inter:Regular',sans-serif] font-normal leading-[30px] left-[320.14px] not-italic text-[#6b7280] text-[20px] text-center top-[-0.27px] w-[611px]">{`We specialize exclusively in budget stays in Istanbul. Here's how we're different.`}</p>
    </div>
  );
}
...
function Group() {
  return (
    <div className="absolute contents left-[calc(16.67%+112px)] not-italic text-[#fafafa] text-center top-[259px]">
      <p className="-translate-x-1/2 absolute font-['Poppins:Bold',sans-serif] leading-[72px] left-[calc(16.67%+640.5px)] text-[64px] top-[259px] w-[1057px]">Budget Hotels in Istanbul Direct Rates. No Hidden Fees</p>
